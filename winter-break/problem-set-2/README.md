...
#### Problem 1 - Arduino Analog
* Use a potentiometer as a switch to control two LEDs. Have the potentiometer start turned all the way to the left (default state), and LEDs should be OFF at the beginning. As you turn the potentiometer to the right, the first LED should turn on when you pass a certain point, and the second LED should turn on after you pass another point. You can choose these points.
...
#### Problem 4 - Save Energy...Save the World
...
#### Problem 5 - Newton’s Luminescent Cradle
